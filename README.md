...
* [Package Management Distro Comparison](https://github.com/kinderp/csheet/blob/master/README.md#package-management-distro-comparison-origin)
...
* [Managing Software with Command Line Tools](https://github.com/kinderp/csheet/blob/master/README.md#managing-software-with-command-line-tools-origin)
  * [Zypper](https://github.com/kinderp/csheet/blob/master/README.md#zypper)
    ...
    2. [Selecting Which Packages to Install or Remove](https://github.com/kinderp/csheet/blob/master/README.md#selecting-which-packages-to-install-or-remove-origin)
    3. [Combining Installation and Removal of Packages](https://github.com/kinderp/csheet/blob/master/README.md#combining-installation-and-removal-of-packages-origin)
    4. [Cleaning Up Dependencies of Removed Packages](https://github.com/kinderp/csheet/blob/master/README.md#cleaning-up-dependencies-of-removed-packages-origin)
    5. [Using Zypper in Scripts](https://github.com/kinderp/csheet/blob/master/README.md#using-zypper-in-scripts-origin)
    6. [Installing or Downloading Source Packages](https://github.com/kinderp/csheet/blob/master/README.md#installing-or-downloading-source-packages-origin)
    7. [Installing Packages from Disabled Repositories](https://github.com/kinderp/csheet/blob/master/README.md#installing-packages-from-disabled-repositories-origin)
    8. [Utilities](https://github.com/kinderp/csheet/blob/master/README.md#utilities-origin)
    9. [Updating Software with Zypper](https://github.com/kinderp/csheet/blob/master/README.md#updating-software-with-zypper-origin)
    10. [Installing All Needed Patches](https://github.com/kinderp/csheet/blob/master/README.md#installing-all-needed-patches-origin)
    11. [Listing Patches](https://github.com/kinderp/csheet/blob/master/README.md#listing-patches-origin)
    12. [Installing New Package Versions](https://github.com/kinderp/csheet/blob/master/README.md#installing-new-package-versions-origin)
    13. [Identifying Orphaned Packages](https://github.com/kinderp/csheet/blob/master/README.md#identifying-orphaned-packages-origin)
    14. [Identifying Processes and Services Using Deleted Files](https://github.com/kinderp/csheet/blob/master/README.md#identifying-processes-and-services-using-deleted-files-origin)
    15. [Managing Repositories with Zypper](https://github.com/kinderp/csheet/blob/master/README.md#managing-repositories-with-zypper-origin)
    16. [Adding Repositories](https://github.com/kinderp/csheet/blob/master/README.md#adding-repositories-origin)
    17. [Refreshing Repositories](https://github.com/kinderp/csheet/blob/master/README.md#refreshing-repositories-origin)
    18. [Removing Repositories](https://github.com/kinderp/csheet/blob/master/README.md#removing-repositories-origin)
    19. [Modifying Repositories](https://github.com/kinderp/csheet/blob/master/README.md#modifying-repositories-origin)
    20. [Querying Repositories and Packages with Zypper](https://github.com/kinderp/csheet/blob/master/README.md#querying-repositories-and-packages-with-zypper-origin)
    21. [Searching for Software](https://github.com/kinderp/csheet/blob/master/README.md#searching-for-software-origin)
    22. [Searching for Specific Capability](https://github.com/kinderp/csheet/blob/master/README.md#searching-for-specific-capability-origin)
    23. [Showing Package Information](https://github.com/kinderp/csheet/blob/master/README.md#showing-package-information-origin)
    24. [Configuring Zypper](https://github.com/kinderp/csheet/blob/master/README.md#configuring-zypper-origin)
